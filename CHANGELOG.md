...
- Bug #47: Update `RoadRunner` constructor to `bootstrapContainer()` before worker instantiation (@terabytesoftw)
...
- Bug #46: Update `yii2-extensions/psr-bridge` to `0.2.0` in `composer.json` (@terabytesoftw)
